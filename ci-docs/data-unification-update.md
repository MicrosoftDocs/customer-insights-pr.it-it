...
1. Facoltativamente, puoi modificare la chiave primaria per un'entità, i tipi di attributo e attivare/disattivare **Mapping intelligente**. Per ulteriori informazioni, vedi [Seleziona la chiave primaria e il tipo semantico per gli attributi](map-entities.md#select-primary-key-and-semantic-type-for-attributes).
